! function(t) {
    ...
    function e(t) {
        if (!t) throw Error("No options passed to Waypoint constructor");
    ...
    e.prototype.queueTrigger = function(t) {
        ...
        for (var r = 0, n = e.length; n > r; r++) e[r][t]()
...
function(t) {
    ...
    function i(e) {
        this.element = e, this.Adapter = n.Adapter, this.adapter = new this.Adapter(e), this.key = "waypoint-context-" + o, this.didScroll = !1, this.didResize = !1, this.oldScroll = {
            x: this.adapter.scrollLeft(),
            y: this.adapter.scrollTop()
        }, this.waypoints = {
            vertical: {},
            horizontal: {}
        }, e.waypointContextKey = this.key, r[e.waypointContextKey] = this, o += 1, n.windowContext || (n.windowContext = !0, n.windowContext = new i(t)), this.createThrottledScrollHandler(), this.createThrottledResizeHandler()
    }
    var o = 0,
        r = {},
        n = t.Waypoint,
    ...
    i.prototype.add = function(t) {
        ...
        s && s(), i.refreshAll()
    }, n.requestAnimationFrame = function(i) {
        var o = t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || e;
        o.call(t, i)
    }, n.Context = i
}(window),
function(t) {
    ...
    o.prototype.add = function(t) {
        ...
        for (var t in this.triggerQueues) {
            var o = this.triggerQueues[t],
                r = "up" === t || "left" === t;
            o.sort(r ? i : e);
            for (var n = 0, s = o.length; s > n; n += 1) {
                var a = o[n];
                (a.options.continuous || n === o.length - 1) && a.trigger([t])
            }
        }
        ...
        return r[t.axis][t.name] || new o(t)
    }, n.Group = o
}(window),
function(t) {
    "use strict";
    ...
    }), i.each(["extend", "inArray", "isEmptyObject"], function(t, o) {
        e[o] = i[o]
    }), o.adapters.push({
        name: "jquery",
        Adapter: e
    ...
    function e(t) {
        return function() {
            ...
            return t.isFunction(arguments[0]) && (o = t.extend({}, arguments[1]), o.handler = arguments[0]), this.each(function() {
                ...
                "string" == typeof r.context && (r.context = t(this).closest(r.context)[0]), e.push(new i(r))
            }), e
        }
    }
    var i = t.Waypoint;
    t.jQuery && (t.jQuery.fn.waypoint = e(t.jQuery)), t.Zepto && (t.Zepto.fn.waypoint = e(t.Zepto))
}(window);